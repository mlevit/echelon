...
<template>
  <div class="min-h-screen px-4 py-6 dark:bg-background-darker sm:ml-64">
    ...
    <!-- <div class="mb-4 flex h-fit items-center justify-center rounded bg-background dark:bg-background-darker">
      <RunList :entityName="entityData.name" v-if="entityData.name" />
    </div> -->
    <!-- <div class="mb-4 flex h-48 items-center justify-center rounded bg-background dark:bg-background-darker">
        <p class="text-2xl text-gray-400 dark:text-gray-500">+</p>
      </div>
      <div class="grid grid-cols-2 gap-4">
        <div class="flex h-28 items-center justify-center rounded bg-background dark:bg-background-darker">
          <p class="text-2xl text-gray-400 dark:text-gray-500">+</p>
        </div>
        <div class="flex h-28 items-center justify-center rounded bg-background dark:bg-background-darker">
          <p class="text-2xl text-gray-400 dark:text-gray-500">+</p>
