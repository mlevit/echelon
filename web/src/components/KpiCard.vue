...
<template>
  ...
  >
    ...
    <div class="flex items-baseline" :class="textColor">
      <span class="text-7xl font-extrabold capitalize tracking-tight">
        {{ value || 0 }}
      </span>
      <span class="ml-1 text-xl font-normal text-gray-500 dark:text-gray-400">{{ unit }}</span>
    </div>
  </div>
</template>
