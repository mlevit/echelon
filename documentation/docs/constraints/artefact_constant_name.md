...
|transform_sql|text|false|For instances where a view cannot be created, SQL transformation logic for the process can be stored here.|
|transform_view|text|false|View that contains transformation logic for the process.|
