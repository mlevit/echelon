exports.up = async function (knex) {
  return knex.schema.createTable(
    ...
    function (table) {
      table.increments("constraint_glossary_entry_rel_type_id");
      table.string("value").notNullable();
      table.string("reverse").notNullable();
      table.text("comment");
      table
...
exports.down = async function (knex) {
  return knex.schema.dropTableIfExists("constraint_glossary_entry_rel_type");
};
