exports.up = async function (knex) {
  return knex.schema.createTable("constraint_data_mask_type", function (table) {
    table.increments("constraint_data_mask_type_id");
...
exports.down = async function (knex) {
  return knex.schema.dropTableIfExists("constraint_data_mask_type");
};
