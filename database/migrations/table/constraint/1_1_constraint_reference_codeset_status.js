exports.up = async function (knex) {
  return knex.schema.createTable(
    "constraint_reference_codeset_status",
    function (table) {
      table.increments("constraint_reference_codeset_status_id");
...
exports.down = async function (knex) {
  return knex.schema.dropTableIfExists("constraint_reference_codeset_status");
};
