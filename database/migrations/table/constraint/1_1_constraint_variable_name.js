exports.up = async function (knex) {
  return knex.schema.createTable("constraint_variable_name", function (table) {
    table.increments("constraint_variable_name_id");
    ...
    table.unique(["value", "object_type"], { useConstraint: true });
  });
};

exports.down = async function (knex) {
  return knex.schema.dropTableIfExists("constraint_variable_name");
};
