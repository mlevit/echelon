exports.up = async function (knex) {
  return knex.schema.createTable("constraint_entity_type", function (table) {
    table.increments("constraint_entity_type_id");
...
exports.down = async function (knex) {
  return knex.schema.dropTableIfExists("constraint_entity_type");
};
