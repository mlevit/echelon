exports.up = async function (knex) {
  return knex.schema.createTable("constraint_job_type", function (table) {
    table.increments("constraint_job_type_id");
...
exports.down = async function (knex) {
  return knex.schema.dropTableIfExists("constraint_job_type");
};
