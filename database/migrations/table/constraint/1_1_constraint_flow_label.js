exports.up = async function (knex) {
  return knex.schema.createTable("constraint_flow_label", function (table) {
    table.increments("constraint_flow_label_id");
...
exports.down = async function (knex) {
  return knex.schema.dropTableIfExists("constraint_flow_label");
};
