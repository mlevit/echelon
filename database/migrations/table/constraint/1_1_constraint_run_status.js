exports.up = async function (knex) {
  return knex.schema.createTable("constraint_run_status", function (table) {
    table.increments("constraint_run_status_id");
...
exports.down = async function (knex) {
  return knex.schema.dropTableIfExists("constraint_run_status");
};
