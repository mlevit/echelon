exports.up = async function (knex) {
  return knex.schema.createTable("constraint_alert_code", function (table) {
    table.increments("constraint_alert_code_id");
...
exports.down = async function (knex) {
  return knex.schema.dropTableIfExists("constraint_alert_code");
};
