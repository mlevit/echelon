exports.up = async function (knex) {
  return knex.schema.createTable("constraint_artefact_type", function (table) {
    table.increments("constraint_artefact_type_id");
...
exports.down = async function (knex) {
  return knex.schema.dropTableIfExists("constraint_artefact_type");
};
