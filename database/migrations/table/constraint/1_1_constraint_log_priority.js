exports.up = async function (knex) {
  return knex.schema.createTable("constraint_log_priority", function (table) {
    table.increments("constraint_log_priority_id");
...
exports.down = async function (knex) {
  return knex.schema.dropTableIfExists("constraint_log_priority");
};
