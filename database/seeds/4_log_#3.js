  ...
  return knex("log").insert([
    {
      ...
      insert_date: "2020-01-03 3:00:00",
    },
    {
      process_audit_id: knex("process_audit")
        .where({
      ...
      function: "start_process",
      priority: "INFO",
      message: "File 'sakila_customer_20200103.csv' was picked up.",
      insert_date: "2020-01-03 3:00:01",
    },
    {
      process_audit_id: knex("process_audit")
        .where({
      ...
      priority: "INFO",
      message:
        "File 'sakila_customer_20200103.csv' was loaded into 'staging.sakila_customer'.",
    ...
    },
    {
      ...
      function: "start_process",
      priority: "INFO",
      message: "File 'sakila_inventory_20200103.csv' was picked up.",
      insert_date: "2020-01-03 3:00:01",
    },
    {
      process_audit_id: knex("process_audit")
      ...
      priority: "INFO",
      message:
        "File 'sakila_inventory_20200103.csv' was loaded into 'staging.sakila_inventory'.",
      insert_date: "2020-01-03 3:03:00",
    },
    {
      process_audit_id: knex("process_audit")
    ...
    },
    {
      ...
      function: "start_process",
      priority: "INFO",
      message: "File 'sakila_rental_20200103.csv' was picked up.",
      insert_date: "2020-01-03 3:00:01",
    },
    {
      process_audit_id: knex("process_audit")
      ...
      priority: "FATAL",
      message:
        "File 'sakila_rental_20200103.csv' could not be loaded into 'staging.sakila_rental' due to type mismatch with field 'rental_date'.",
      insert_date: "2020-01-03 3:03:00",
    },
    {
      process_audit_id: knex("process_audit")
    ...
    },
    {
      ...
      function: "start_process",
      priority: "INFO",
      message: "File 'sakila_staff_20200103.csv' was picked up.",
      insert_date: "2020-01-03 3:00:01",
    },
    {
      process_audit_id: knex("process_audit")
      ...
      priority: "INFO",
      message:
        "File 'sakila_staff_20200103.csv' was loaded into 'staging.sakila_staff'.",
      insert_date: "2020-01-03 3:03:00",
    },
    {
      process_audit_id: knex("process_audit")
